...
* @author PrestaShop SA <contact@prestashop.com>
    ...
    *}
    ...
    <div id="reminder_listing"
        class="panel panel-default panel-blockreassurance col-lg-10 col-lg-offset-1 col-xs-12 col-xs-offset-0">
            ...
            <div class="clearfix">
                <div class="listing-table col-xs-12">
                    <div class="listing-head row">
                        ...
                        <div class="col-xs-4 content-header">{l s='Description' d='Modules.Blockreassurance.Admin'}
                        </div>
                        <div class="col-xs-2 content-header">{l s='Redirection' d='Modules.Blockreassurance.Admin'}
                        </div>
                                ...
                                <div class="col-xs-2 inline-flex">
                                    <label class="col-lg-12 col-xs-12 status-toggle"
                                        ...
                                        <span class="switch_text switch-on"
                                            style="{if !$block['status']}display:none;{/if}">{l s='Activated'
                                            d='Modules.Blockreassurance.Admin'}</span>
                                        <span class="switch_text switch-off"
                                            style="{if $block['status']}display:none;{/if}">{l s='Deactivated'
                                            d='Modules.Blockreassurance.Admin'}</span>
                                    </label>
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start">
                                            <span class="dropdown-item psre-edit"
                                                data-id="{$block['id_psreassurance']}"><i
                                                    class="material-icons">mode_edit</i> {l s='Edit'
                                                d='Admin.Actions'}</span>
                                            <span class="dropdown-item psre-delete"
                                                data-id="{$block['id_psreassurance']}"><i
                                                    class="material-icons">delete</i> {l s='Delete'
                                                d='Admin.Actions'}</span>
                                        </div>
                                    </div>
                                </div>
