...
{block name='head_seo'}
  <title>{block name='head_seo_title'}{l s='Demande Abonnement Jawhara' mod='demandeabonnement'}{/block}</title>
{/block}
...
{block name='breadcrumb'}
  ...
  <div class="jawharaHeader">
    <img src="{$module_dir|escape:'html':'UTF-8'}views/img/jawharaLogo.png" class="jawharaLogo">
    <img src="{$module_dir|escape:'html':'UTF-8'}views/img/jawharaRight.png" class="diwanRight">
  </div>
{/block}
...
{block name='content' }
  ...
  <div id="main">
    ...
    {block name='page_content_container'}
      ...
      <section id="content" class="page-content abo-form-card abo-card-block ">{*class="page-content card card-block"*}
        ...
        {block name='page_content' }
          <div class="row">
            ...
            <div class="col ">
              <label
                class="title-form-page font-size-35 font-weight-bold   ">{l s='Formulaire d’abonnement' mod='demandeabonnement' }</label>
              <div>
            ...
            <div class="stepwizard">
              <div class="stepwizard-row setup-panel">
                <div class="stepwizard-step">
                  <a href="#step-1" type="button" class="btn  btn-step btn-circle">1</a>
...
{* 
<footer class="page-footer footerDiwan">
<div style="display: flex;align-items: center;justify-content: center;height: auto;padding: 20px 0;">
<span>Powered by&nbsp;</span>
<img src="/img/logo-1673600574.jpg" style="width: 100px;">

</div>
<div class="footerCopy">
<span>© 2022 Nety. All rights reserved</span>
<a href="/content/2-mentions-légales">Mentions légales</a>
<a href="/content/3-conditions-générales">Conditions générales </a>
</div>
</footer> *}