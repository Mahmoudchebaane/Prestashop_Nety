...
class RevsliderPrestashop extends Module
{
    ...
    public function hookdisplayHeader()
    {
        ...
        if(_PS_VERSION_ >= 1.7){
             $this->context->controller->registerJavascript('modules-revsliderprestashop12', 'modules/'.$this->name.'/public/assets/js/jquery.themepunch.tools.min.js', ['attribute'=>'defer','position' => 'bottom', 'priority' => 1500]);        
