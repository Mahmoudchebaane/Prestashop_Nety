 ...
 *}
 ...
 {block name='head_seo'}
   <title>{block name='head_seo_title'}{l s='Demande Abonnement Diwan' mod='demandeabonnement'}{/block}</title>
 {/block}
 ...
 {block name='breadcrumb'}
  <div class="diwanHeader">   
    <img src="{$module_dir|escape:'html':'UTF-8'}views/img/logoDiwan.png" class="diwanLogo">
    <img src="{$module_dir|escape:'html':'UTF-8'}views/img/diwanRight.png" class="diwanRight">
  </div>
 {/block}
                 ...
                 <div>
                   ...
                   <div>
                     ...
                     <div class="my-15 mr-10 d-flex align-items-center justify-content-end flex-wrap">
                       ...
                       <input class="form-control" type="text" id="captcha-input" required placeholder="{l s='Enter Captcha code' mod='demandeabonnement' }" />
