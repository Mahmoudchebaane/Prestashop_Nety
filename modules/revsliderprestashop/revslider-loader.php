...
function esc_htmls($value){
    return $value;
}
function esc_attrs($value,$ext=''){
    return $value;
}
...
//    return $file_url;
//}
function plugins_urls($file,$filepath) { 
...
function plugin_dir_urls($fileurl){
