...
class BinshopsrestRegisterModuleFrontController extends AbstractRESTController
{
    protected function processPostRequest()
    {
        ...
        $ref_client = Tools::getValue('ref_client');
        ...
        if (!$hasError) {
            ...
            try { 
                ...
                if($ref_abonnement){
                    $customer->ref_abonnement = $ref_abonnement;
                    $customer->ref_client = $ref_client;
                    $customer->num_fixe = $num_fixe;
                    $client = new Client();
                    try {
                ...
                $psdata = array(
                    ...
                    'ref_client' => $customer->ref_client,
