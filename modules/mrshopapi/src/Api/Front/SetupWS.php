...
class SetupWS extends BaseWS
{
    public function getList($params, $id_customer = null)
    {
        ...
        $data['registration_fields'] = CustomFormUtils::getRegistrationFields($this->dataHandler->getApiVersion());
        ...
        if (!empty(Configuration::get('PS_GUEST_CHECKOUT_ENABLED'))) {
            $data['guest_registration_fields'] = CustomFormUtils::getRegistrationFields($this->dataHandler->getApiVersion(),['passwd']);
        }
