        ...
        <div class="container" style="margin-top: 25px;">
            ...
            <div id="content-wrapper" class="js-content-wrapper left-column right-column col-sm-4 col-md-6">
                ...
                <div id="{$buttonId}-form" class="">
                    ...
                    {$option.form nofilter} {* HTML comment, no escape necessary like cms/page.tpl in ps classic theme to render cms page content for App*}
                    ...
                    <div class="payment-options" style="margin-bottom:20px;">
                            ...
                            <div id="payment-option-1-container" class="payment-option clearfix" style="display:none">
                                                <span class="custom-radio pull-xs-left">
                                                    <input class="ps-shown-by-js binary" id="payment-option-1"
                                                           data-module-name="{$option.module_name} {* HTML comment, no escape necessary like cms/page.tpl in ps classic theme to render cms page content for App*}"
                        ...
                        {else}
                        <form id="payment-form" method="POST" action="{$option.action nofilter}"> {* HTML comment, no escape necessary like cms/page.tpl in ps classic theme to render cms page content for App*}
                            {foreach from=$option.inputs item=input}
                                <input type="{$input.type}" name="{$input.name} {* HTML comment, no escape necessary like cms/page.tpl in ps classic theme to render cms page content for App*}" value="{$input.value}">
                            {/foreach}
