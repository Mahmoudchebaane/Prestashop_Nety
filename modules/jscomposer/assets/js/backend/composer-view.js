    ...
    var VisualComposer = Backbone.View.extend({
        ...
        render: function() {
            ...
            if (this.accessPolicy !== 'only') {
                if (vc_frontend_enabled == true) front = '<span class="vc_spacer"></span><a class="wpb_switch-to-front-composer" href="' + $('#wpb-edit-inline').attr('href') + '">' + window.i18nLocale.main_button_title_frontend_editor + '</a>';
                if (vc_backend_enabled == true) back = '<a class="wpb_switch-to-composer" href="#">' + window.i18nLocale.main_button_title_backend_editor + '</a>'
            ...
            this.$post = $('[name=' + window.vcActiveTextFieldName + '_' + window.sds_id_lang(null, 1) + ']');
