...
define('LINK_CRM','https://crm.chifco.com');//link API crm
define('LINK_SMT','https://test.clictopay.com');//link payment prod SMT
define('PAYMENT_LOGIN', '0870565017');//prod username payment
define('PAYMENT_PASSWD', 'L32yKy6k');//prod password payment
define('NETY_SHOP', 1); //id shop nety
define('JAWHRA_ABON', 2);//id shop jawhara 
define('DIWAN_ABON', 3);//id shop diwan 
define('NETY_PRO', 8);//id shop b2b
// define('NETY_PRO', 8);//id shop b2b
define('CSS_ABON', 9);//id shop CSS 
define('PACK_CATEGORY', 4);//id internet offers category
define('PRO_CATEGORY', 24);//id b2b offers category 
define('RAPIDO_PRO',25 );//id rapido category 
define('FAST_PRO',26);//id fast link category 


// PROD
// define('LINK_CRM','https://customer.chifco.com');//link API crm
// define('LINK_SMT','https://ipay.clictopay.com');//link payment prod SMT
// define('PAYMENT_LOGIN', '0870565017');//prod username payment
// define('PAYMENT_PASSWD', '9K{[,tZ)');//prod password payment
// define('NETY_SHOP', 1);//id shop nety
// define('NETY_PRO', 2);//id shop b2b
// define('DIWAN_ABON', 3);//id shop diwan 
// define('JAWHRA_ABON', 4);//id shop jawhara 
// define('CSS_ABON', 5);//id shop CSS 
// define('PACK_CATEGORY', 4);//id internet offers category 
// define('PRO_CATEGORY', 20);//id b2b offers category 
// define('RAPIDO_PRO',21);//id rapido category 
// define('FAST_PRO',22);//id fast link category 
