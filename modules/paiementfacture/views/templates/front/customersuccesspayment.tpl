  ...
  {block name='page_content_container'}
    <section id="content" class="page-content abo-form-card abo-card-block paiementSection ">
      ...
      {block name='page_content' }
          ...
          <div class="p-40 flex-row justify-content-center d-flex text-success ">
          <sapn> <i class="zmdi zmdi-check-circle-u zmdi-hc-5x mr-20"></i> </sapn><h2  class="mt-25" >{l s='Votre paiement a été effectué avec succès.' mod='paiementfacture' } </h2> 
           </div>
            <div class="mb-30 flex-row justify-content-center d-flex ">           
            <button class="donePF" type="button" onclick="location.href='{$listpaylink|escape:'html':'UTF-8'}'" > <i class="fa fa-angle-left ml-3"></i> {l s='Mes factures' d='Shop.Theme.Customeraccount'}</button>
            </div> 
