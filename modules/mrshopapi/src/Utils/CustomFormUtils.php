...
class CustomFormUtils
{
    ...
    public static function getRegistrationFields($apiVersion, $exclude = [], $isGuest = null)
    {
        $module = ApiUtils::getModule();
        ...
        if (Module::isEnabled('addressregister') && $apiVersion >= 16 && !$isGuest) {
            $registrationFields[] = [
                'id' => 'id_country',
                'name' => $module->l('Country', 'basews'),
                'type' => 'select',
                'field' => 'Country:name',
                'required' => true,
