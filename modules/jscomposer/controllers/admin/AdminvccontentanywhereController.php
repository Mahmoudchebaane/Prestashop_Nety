...
class AdminvccontentanywhereController extends ModuleAdminController {
	...
	public function processPosition() {
		...
		} elseif ( ! Validate::isLoadedObject( $object = new vccontentanywhere( (int) Tools::getValue( $this->identifier, Tools::getValue( 'id_vccontentanywhere', 1 ) ) ) ) ) {
	...
	public function processSave() {
		...
		if (
			...
			if ( $cat_page == 1 ) {
				$object->cat_specify = '';
			} elseif ( Tools::isSubmit( 'cat_specify_temp' ) && is_object( $object ) ) {
			...
			if ( $cms_page == 1 ) {
				$object->cms_specify = '';
			} elseif ( Tools::isSubmit( 'cms_specify_temp' ) && is_object( $object ) ) {
