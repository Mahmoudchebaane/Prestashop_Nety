	...
	array(
		...
		'params'        => array(
			array(
				...
				'param_name' => 'content',
				'value'      => $vc_main->l('I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.'),
			),
			$add_css_animation,
			array(
				'type'        => 'textfield',
				...
				'param_name'  => 'el_class',
				'value'       => '',
				'description' => $vc_main->l('1If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.'),
			),
			array(
				'type'       => 'css_editor',
				'heading'    => $vc_main->l('Css'),
	...
	array(
		...
		'params'        => array(
			...
			array(
				...
				'param_name' => 'content',
				'value'      => $vc_main->l('I am message box. Click edit button to change this text.'),
			),
			$add_css_animation,
			array(
				'type'        => 'textfield',
	...
	array(
		...
		'params'      => array(
			...
			array(
				...
				'param_name'  => 'content',
				'value'       => $vc_main->l('Toggle content goes here, click edit button to change this text.'),
			...
			array(
				...
				'description' => $vc_main->l('Select if you want toggle to be open by default.'),
			),
			$add_css_animation,
			array(
				'type'        => 'textfield',
...
vc_map(
	array(
		...
		'params'      => array(
			...
			array(
				'type'        => 'textfield',
				'heading'     => $vc_main->l('Alternative Text'),
				'param_name'  => 'alt_text',
				'description' => $vc_main->l('Enter text which will be used as alternative text.'),
			),
			array(
				'type'        => 'textfield',
				'heading'     => $vc_main->l('Extra class name'),
	...
	array(
		...
		'params'      => array(
			...
			array(
				...
				'description' => $vc_main->l('If YES prev or next control will be removed.'),
				'value'       => array($vc_main->l('Yes') => 'yes'),
			),
			array(
				'type'        => 'checkbox',
		...
		array(
			...
			'params'      => array(
				...
				array(
					...
					'value'       => array($vc_main->l('Yes') => true),
					'dependency'  => array(
	...
	array(
		...
		'params'        => array(
			array(
				...
				'param_name'  => 'content',
				'value'       => base64_encode('Click edit button to change this html'),
