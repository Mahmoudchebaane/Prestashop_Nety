...
class CmsWS extends BaseWS
{
    ...
    {
        return 'SELECT c.`id_cms` AS id, mcms.`id_cms_page`, c.`position`, cl.`meta_title`, cl.`content`,  COALESCE (mcms.`simple_cms`,0)
			...
			AND mcms.`id_cms_page` IS NOT NULL';
    }
    ...
    private function renderContent($cmsPage)
    {
        if (version_compare(_PS_VERSION_, '1.7.0', '>=')) {
            ...
            $path = 'modules/mrshopapi/views/templates/front/simple_web_cms_page.tpl';
        }
