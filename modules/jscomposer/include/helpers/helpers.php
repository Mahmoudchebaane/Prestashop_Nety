...
function wpb_getImageBySize( $params = array( 'post_id' => NULL, 'attach_id' => NULL, 'thumb_size' => '', 'class' => '', 'alt' => "Vc Image Alt" ) ) {
    ...
    if(isset($params['attach_id']) && !empty($params['attach_id'])){
        ...
        $thumbnail = '<img class="' . $thumb_class . '"  alt="'.$alt .'" width="' . $width . '" height="'. $height.'" src="'.JsComposer::ModifyImageUrl($mainImg). '" />';
