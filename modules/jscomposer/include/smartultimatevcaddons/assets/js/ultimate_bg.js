(function ( $ ) {
             ...
             function vc_viewport_video()
                    ...
                    function ult_vc_seperators(selector, parent)
                    {
                            ...
                            if(typeof seperator != 'undefined' && seperator.toString() == 'true')
                            {
                                    ...
                                    if(parent.hasClass('vc_row')){
                                        parent.prepend(seperator_html);
                                    }else{
                                        parent.prev().prepend(seperator_html);
                                    }
            ...
            jQuery.fn.ultimate_video_bg = function(option) {
                    jQuery(this).each(function(){
                            ...
                            {
                                    if(selector.prev().is('p') || selector.prev().is('style') || selector.prev().is('div.vc_row-full-width'))
                    ...
                    jQuery(this).each(function(){
                            ...
                            if(vc < 4.4 || theme_support == 'enable')
                            {
                                    if(selector.prev().is('p') 
                                            ...
                                            || selector.prev().is('div.vc_row-full-width')
                                            )
                                            var parent = selector.prev().prev();
                                    else{
                                            var parent = selector.prev();
		...
		jQuery(document).ready(function(){
			...
			jQuery('.upb_no_bg').each(function(index, nobg) {
				...
				var theme_support = jQuery(nobg).data('theme-support');
                                ...
                                var hide_row_class = jQuery(nobg).data('hide-row');
				...
				if(parallax_content == 'parallax_content_value')
				{
					...
					parent[0].style.setProperty( 'padding-bottom', '0px', 'important' );
                                ...
                                parent.addClass(hide_row_class);
