...
class Contactform extends Module implements WidgetInterface
{
    ...
    public function sendMessage()
    {
        ...
        //$message = $this->l('Name:'). ' '.trim(Tools::getValue('name')) . '<br>' . $this->l('tel:'). ' '.trim(Tools::getValue('tel')) . '<br>' . $this->l('gsm:' ). ' ' . trim(Tools::getValue('gsm')) . '<br>' . trim(Tools::getValue('message'));
        ...
        if (!($from = trim(Tools::getValue('from'))) || !Validate::isEmail($from)) {
            ...
            if (!count($this->context->controller->errors)
                ...
                $var_list = [
                    ...
                    '{email}' =>  $from,
                    '{tel}' => Tools::nl2br(Tools::htmlentitiesUTF8(Tools::stripslashes($tel))),
                    '{gsm}' => Tools::nl2br(Tools::htmlentitiesUTF8(Tools::stripslashes($gsm))),
                    '{address}' => Tools::nl2br(Tools::htmlentitiesUTF8(Tools::stripslashes($address))),
                    '{product_name}' => '',
                ];
