    ...
    <form action="{$link->getPageLink('contact')|escape:'html':'UTF-8'}" method="post" {if
      ...
      <section class="form-fields">
        ...
        <div class="form-group row no-flow">
          <div class="col-md-6">
            <input class="form-control contactInput" name="name" placeholder="{l s='Name*' d='Shop.Forms.Help'}"
              required>
          </div>
          <div class="col-md-6">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-6">
            <input id="tel" class="form-control contactInput" name="gsm" type="tel" required
        ...
        <div class="form-group row">
          ...
          <div class="col-md-12">
            <textarea class="form-control " name="message" placeholder="{l s='Message*' d='Shop.Forms.Help'}" required
              rows="8">{if $contact.message}{$contact.message} {/if}{$contact|@json_encode  nofilter}</textarea>
          </div>
