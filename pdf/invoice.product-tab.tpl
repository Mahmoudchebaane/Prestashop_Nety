...
<table class="product" width="100%" cellpadding="4" cellspacing="0">
  ...
  <tr>
    ...
    {if $isTaxEnabled}
      <th class="product header small" width="15%">{l s='Tax Rate' d='Shop.Pdf' pdf='true'}</th>
    {/if}
    ...
    <tr class="product {$bgcolor_class}">
      ...
      <td class="product right">
        ...
        {if $order_detail.ecotax_tax_excl > 0}
          <br>
          <small>
          {displayPrice currency=$order->id_currency price=$order_detail.ecotax_tax_excl}|string_format:{l s='ecotax: %s' d='Shop.Pdf' pdf='true'}
          </small>
        {/if}
      </td>
      <td class="product center">
